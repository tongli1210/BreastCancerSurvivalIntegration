...
from util.util_data_split import validation_split
...
shared_transform=transforms.Compose([transforms.ToTensor(), # first, convert image to PyTorch tensor
                                     transforms.Normalize((0.1307,), (0.3081,)) # normalize inputs
                                    ])
mnist_dataset_train = dataset(opt, train=True, transform=shared_transform)
dataset_train, dataset_vali = validation_split(mnist_dataset_train)
