...
class Model(NetInterface):
    ...
    def __init__(self, opt, logger):
        ...
        # general
        self.opt =opt  
        self._metrics = ['loss_mse', 'loss_mse_cross', 'loss_clf'] # log the autoencoder loss and the classification loss
        if opt.log_time:
            self._metrics += ['t_mse', 't_mse_cross', 't_clf']
    ...
    def __str__(self):
        s = "MNIST Simulated CrossAutoencoder Concat"
        return s
