...
def add_general_arguments(parser):
    ...
    parser.add_argument('--adam_beta2', type=float, default=0.9,
                        help='beta2 of adam')
    parser.add_argument('--adam_wdecay', type=float, default=0.0,
    ...
    parser.add_argument('--sgd_wdecay', type=float, default=0.0,
    ...
    parser.add_argument('--exp_gamma', type=float, default=0.99,
                        help='multiplicative factor of exponential learning rate decay. default: 0.99')
    parser.add_argument('--cos_T_max', type=int, default=300,
                        help='maximum number of iterations')
    parser.add_argument('--cos_eta_min', type=float, default=0,
                        help='minimum learning rate. default: 0')
    parser.add_argument('--warmup_epoch', type=int, default=0,
                        help='number of epochs for linear learning rate warmup, default 0 to disable warmup')
